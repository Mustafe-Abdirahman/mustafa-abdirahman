        ...
        <div className="flex justify-between items-center px-5 max-w-screen-2xl mx-auto">
          <div className=" text-[2.5rem] duration-500 font-semibold group cursor-pointer">
            <p className="animatedHeading font-signature">
              <span className="text-transparent">Mustafa</span>
          ...
          <Navigation
            ...
            } duration-500 flex flex-col h-screen bg-gradient-to-b from-black to-gray-800 w-screen xs:w-80  top-0 right-0 absolute items-center justify-center md:scale-0`}
